...
long long unsigned int sumBien(int MTA[][MAX], int mA, int nA, int maxNumA) {
    
    drawMT(MTA, mA, nA, maxNumA);
    
    long long unsigned int multi = 1, count = 0;
    ...
    multi = multi / count;
    cout << "Trung binh nhan cac so duong la: " << multi << endl;
