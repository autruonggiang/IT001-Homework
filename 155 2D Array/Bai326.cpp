...
void sumArg(int MTA[][MAX], int mA, int nA, int maxNumA) {
    ...
    sum = sum / count; // Tinh trung binh
    
    cout << "Tong trung binh cong cac so duong la: " << sum << endl;
