...
bool CT(int MTA[][MAX], int mA, int nA, int x, int y) {
...
void countCT(int MTA[][MAX], int mA, int nA, int maxNumA) {
    ...
    cout << "So phan tu cuc tri cua ma tran la: " << count << endl;
